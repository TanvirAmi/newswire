	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Theme Stylesheet",
				   ...
				   "type" => "select",
				   "std" => "default.css",
				   "options" => array("default.css","blue.css","red.css"),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
           ...
           array( "name" => "Number of posts to show on Featured Content (right)",
				   "id" => $shortname."_featured_post_num",
				   "type" => "text",
				   "std" => "4",
				   "desc" => "desc",),	

           array( "name" => "Number of characters to show for left featured post",
                   "id" => $shortname."_left_featured_char_num",
                   "type" => "text",
                   "std" => "140",
				   "desc" => "desc."),

           array( "name" => "Number of characters to show for right featured posts",
                   "id" => $shortname."_right_featured_char_num",
                   "type" => "text",
                   "std" => "65",
				   "desc" => "desc."),		        			   

	   array( "name" => "Exclude categories from the two column news block",
				   "id" => $shortname."_twocol_cats",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "desc ",
				   "usefor" => "categories",
          ...
          array( "name" => "Number of posts to show per box",
				   "id" => $shortname."_twocol_post_num",
				   "type" => "text",
				   "std" => "3",
				   "desc" => "desc",),	

	 array( "name" => "Number of characters to show for twocol",
                   "id" => $shortname."_twocol_char_num",
                   "type" => "text",
                   "std" => "150",
				   "desc" => "desc."),

	 array( "name" => "Enable bottom content on homepage",
                   "id" => $shortname."_bottom_content_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),

         array( "name" => "Select a category for Bottom Left",
				   "id" => $shortname."_bottom_left_cat",
				   "type" => "select",
				   "desc" => "desc.",
				   "std" => '',				   
				   "usefor" => "categories",
	...
	array( "name" => "Number of characters to show in Bottom Left",
                   "id" => $shortname."_bottom_left_char_num",
                   "type" => "text",
                   "std" => "130",
				   "desc" => "desc."),	

	 array( "name" => "Select a category for Bottom Right",
				   "id" => $shortname."_bottom_right_cat",
				   "type" => "select",
				   "desc" => "desc.",
				   "std" => '',				   
				   "usefor" => "categories",
	...
	array( "name" => "Number of posts to show in Bottom Right",
                   "id" => $shortname."_bottom_right_num",
                   "type" => "text",
                   "std" => "4",
				   "desc" => "desc."),

	   array( "name" => "Number of characters to show in Bottom Right",
                   "id" => $shortname."_bottom_right_char_num",
                   "type" => "text",
                   "std" => "100",
				   "desc" => "desc."),			   	
		...
		array( "name" => "layout-2",
			...
			array( "name" => "Show share buttons on single post",
			...
			array( "name" => "Your Twitter ID",
				   ...
				   "type" => "text",
				   "std" => "theme_junkie",
				   "desc" => "Used for tweet mention",),

			array( "name" => "Show related articles and 300x250 ad on posts",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable ad box below featured content (468x60)",
				   "id" => $shortname."_featured_ad_enable",
				   	"type" => "checkbox",
				   "std" => "false",
				   "desc" => "desc.",),
			...
			array( "name" => "Input header ad code",
				   ...
				   "std" => "",
				   "desc" => "desc",), 
			// Register new input filed for insede the single post content
			array( "name" => "Input inside content ad code for the single post",
				   "id" => $shortname."_inside_content_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 

			array( "name" => "Input ad code below featured content",
				   "id" => $shortname."_featured_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 

			array( "name" => "Input 300x250 ad code for single post",
				   "id" => $shortname."_single_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 	
		    // Register new input field for after embed pdf
		    array( "name" => "Input ad code after first pdf",
				   "id" => $shortname."_pdf1_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",),
		    array( "name" => "Input ad code after second pdf",
				   "id" => $shortname."_pdf2_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 
			array( "name" => "Input ad code after third pdf",
				   "id" => $shortname."_pdf3_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 
			array( "name" => "Input ad code after fourth pdf",
				   "id" => $shortname."_pdf4_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 
			array( "name" => "Input ad code after fifth pdf",
				   "id" => $shortname."_pdf5_ad_code",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "desc",), 			   
